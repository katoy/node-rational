  ...
  var result = {
    ...
    parse: function(input, startRule) {
      ...
      function parse_multiplicative() {
        ...
        pos0 = pos;
        pos1 = pos;
        result0 = parse_powerTerm();
        if (result0 !== null) {
          result1 = [];
          pos2 = pos;
          result2 = parse_MultiplicativeOperator();
          if (result2 !== null) {
            result3 = parse_powerTerm();
            if (result3 !== null) {
              result2 = [result2, result3];
            } else {
              result2 = null;
      ...
      function parse_primary() {
        ...
        if (result0 === null) {
          ...
          if (result0 === null) {
            ...
            if (result0 !== null) {
              result0 = (function(offset, sign, additive) { return sign * additive; })(pos0, result0[0], result0[2]);
            }
            if (result0 === null) {
              pos = pos0;
            }
      ...
      function parse_integer() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, sign, digits) { return sign * parseInt(digits.join(""), 10); })(pos0, result0[0], result0[1]);
        }
        if (result0 === null) {
          pos = pos0;
        }
