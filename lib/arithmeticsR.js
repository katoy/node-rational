  ...
  var result = {
    ...
    parse: function(input, startRule) {
      var parseFunctions = {
        ...
        "basenotation": parse_basenotation,
      ...
      function parse_integer() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, sign, digits, bsn) {
              var base = bsn;
              if (base === "") { base = 10; } 
      ...
      function parse_float() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, sign, parts, bsn) {
              var base = bsn;
              if (base === "") { base = 10; } 
